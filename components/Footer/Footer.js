...
const Footer = () => {
    const description = "KriFin is a revolutionary new platform that is making it easier and more accessible than ever to invest in land estates, agricultural plantations and farm projects. We are the first platform in Asia to offer co-investment and decentralized finance (DeFi) solutions for these asset classes."
